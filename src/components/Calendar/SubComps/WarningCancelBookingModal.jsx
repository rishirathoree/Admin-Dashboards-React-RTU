...
const WarningCancelBookingModal = ({onCancel}) => {
  return (
    <div className='fixed top-0 left-0 h-screen z-50 bg-black/40 w-full flex items-center justify-center'>
        <div className='animate-keep-bounce  w-1/3 h-min rounded-lg bg-white flex flex-col py-8 items-center justify-evenly'>
            ...
            <span className='submissionInner flex items-center justify-center py-12'>
                <span className='block w-24 h-24 rounded-full bg-red-400 flex items-center animate-bounce justify-center text-white'><Check size={32} /></span>
            </span>

            <span className='block space-y-2'>
            <p className='font-bold uppercase text-center text-lg'>Booking Cancel Successful</p>
            <p className='font-semibold text-[12px] text-gray-600 p-4 text-center'>Please wait for the administrator to review your Cancellation Request.</p>
            </span>
...
export default WarningCancelBookingModal